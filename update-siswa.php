    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                // pastikan ada param, contoh: edit-siswa.php?nisn=1234567890
                if (!isset($_GET['nisn'])) {
                ...
                $q = mysqli_query($koneksi, "SELECT * FROM siswa WHERE nisn = '$nisn' LIMIT 1");
                if (!$q || mysqli_num_rows($q) == 0) {
                    // tidak ditemukan
                    header('Location: biodata-siswa.php?msg=notfound');
                    exit;
                }
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active"><a href="biodata-siswa.php">Data Biodata Siswa</a></li>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-update-siswa.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <!-- Hidden field: simpan nisn lama (kunci) -->
                                <input type="hidden" name="nisn_lama" value="<?php echo htmlspecialchars($row['nisn']); ?>">

                                <div class="form-group">
                                    <label for="exampleInputNISN">NISN</label>
                                    <!-- jika NISN juga bisa di-edit: tampilkan value, tapi hati-hati relasi DB -->
                                    <input type="text" name="nisn" class="form-control" id="exampleInputNISN"
                                        placeholder="Masukkan NISN Siswa" required
                                        value="<?php echo htmlspecialchars($row['nisn']); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputName">Nama Lengkap Siswa</label>
                                ...
                                <!-- ... lanjut sama pola untuk alamat, no_hp, email ... -->
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select rounded-0" name="id_kelas" id="namaKelas" required>
                                        <option value="">-- Pilih Nama Kelas --</option>
                                        <?php
                                        // Anda sudah punya $queryKelas
                                        mysqli_data_seek($queryKelas, 0); // pastikan pointer di awal jika sebelumnya dipakai
                                        while($r = mysqli_fetch_assoc($queryKelas)) {
                                        ?>
                                            <option value="<?php echo $r['id_kelas']; ?>"
                                                <?php if($r['id_kelas'] == $row['id_kelas']) echo 'selected'; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password"
                                            ...
                                            placeholder="Masukkan Password Siswa (opsional)"
                                            minlength="6">
                                        <div class="input-group-append">
