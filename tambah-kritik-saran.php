                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active"><a href="kritik-saran.php">Data Kritik & Saran</a></li>
                        ...
                        <form action="proses-tambah-user.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="IdKelas">ID Kritik & Saran</label>
                                    <input type="text" name="kode_operator" value="<?php echo $id_kelas; ?>" 
                                        class="form-control" id="kodeOperator" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="siswa">Nama Siswa</label>
                                    <input list="siswaList" name="nisn" class="form-control" placeholder="Ketik nama siswa..." required>
                                    <datalist id="siswaList">
                                        <?php while($row = mysqli_fetch_assoc($querySiswa)) { ?>
                                            <option value="<?php echo $row['nisn']; ?>"><?php echo $row['nama_lengkap']; ?></option>
                                        <?php } ?>
                                    </datalist>
                                </div>
                                <div class="form-group">
